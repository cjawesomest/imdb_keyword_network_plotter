...
if __name__ == '__main__':
    ...
    # [links_1, names_1] = findMovies(search_term_1)
    # [link_to_movie_1, link_to_cast_1, performer_to_name_1, performer_to_movies_1] = aggregateInfo(links_1, names_1)
    #Save output of search so we don't have to do it again
    # with open("./../dat/"+data_name_1+".dat", 'wb') as file:
    #     obj_out.dump([link_to_movie_1, link_to_cast_1, performer_to_name_1, performer_to_movies_1], file)


    # time_2 = datetime.now()
    # [links_2, names_2] = findMovies(search_term_2)
    # [link_to_movie_2, link_to_cast_2, performer_to_name_2, performer_to_movies_2] = aggregateInfo(links_2, names_2)
    # with open("./../dat/"+data_name_2+".dat", 'wb') as file:
    #     obj_out.dump([link_to_movie_2, link_to_cast_2, performer_to_name_2, performer_to_movies_2], file)
